...
def get_args():
    ...
    parser.add_argument("--coef", default=[0.1, 0.1, 0.1, 0.1], type=float, nargs='+', help="coefficient multiply on utility loss, need to be match with the number of attributes")
