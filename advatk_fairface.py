    ...
    def train():
        ...
        for batch_idx, (data, label) in enumerate(train_dataloader):
            ...
            match args.loss_type:
                case "direct":
                    loss = loss_categori_direct(logit, label, args.sens_type, args.attr_type, coef, 'FairFace')
                case "CE masking":
                    loss = loss_categori_CEmasking(logit, label, args.sens_type, args.attr_type, 'FairFace')
                case "perturbOptim":
                    loss = loss_categori_perturbOptim(logit, label, args.sens_type, args.attr_type, coef, 'FairFace')
                case "full perturbOptim":
                    loss = loss_categori_perturbOptim_full(logit, label, args.sens_type, args.attr_type, coef, 'FairFace')
                case _:
