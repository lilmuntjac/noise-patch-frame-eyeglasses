...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        save_model(model, optimizer, scheduler, name=f'{seed}_UTKfaceAge_{epoch:04d}')
    # save basic statistic
    save_stats(train_stat, f'{seed}_UTKfaceAge_train')
    save_stats(val_stat, f'{seed}_UTKfaceAge_val')
